...
@click.option('--path_sigmsigas_start',       help='path to sigmas start', metavar='DIR',                              type=str, required=True)
@click.option('--path_edm',                help='path to edm', metavar='DIR',                                       type=str, required=True)

def main(index, outdir, path_alex, path_imagenet, path_sigmas_start, path_edm):
    device = 'cuda'
