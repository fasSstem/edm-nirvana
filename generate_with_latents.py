...
@click.option('--outdir_latents',          help='Where to save the output latents', metavar='DIR',                  type=str, required=True)
...
def main(network_pkl, outdir, outdir_latents, subdirs, subdirs_class, seeds, class_idx, max_batch_size, path_to_label_distr=None, device=torch.device('cuda'), **sampler_kwargs):
    """Generate random images using the techniques described in the paper
    "Elucidating the Design Space of Diffusion-Based Generative Models".
